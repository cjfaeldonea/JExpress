			...
			<tbody>
				<?php
					...
					while($row=$query->fetch_array()){
						?>
						<tr>
							<td class="text-center"><a href="<?php if(empty($row['photo'])){echo "upload/noimage.jpg";} else{echo $row['photo'];} ?>"><img class="cropped2" src="<?php if(empty($row['photo'])){echo "upload/noimage.jpg";} else{echo $row['photo'];} ?>"></a></td>
							<td><?php echo $row['productname']; ?><br><cat><?php echo $row['catname']; ?> </cat></td>
